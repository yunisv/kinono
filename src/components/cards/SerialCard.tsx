        ...
        <div>
            ...
            <div className={"cardTitle"}>
                <div style={{
                    ...
                    <NavLink to={`/${props.serialData.type}/${props.serialData.id}`} style={{color: "rgba(255, 255, 255, 0.65)", fontSize: 16, paddingLeft: 10, paddingTop: 10, textAlign: "left"}}>{props.serialData.title}</NavLink>
                </div>
